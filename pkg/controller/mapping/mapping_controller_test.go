...
func TestReconcile(t *testing.T) {
	...
	instance := &smartnatv1alpha1.Mapping{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	...
	reconciler := setupReconcilerWithMocks(t, mgr)
	...
	// Create the Mapping object and expect the Reconcile and Deployment to be created
